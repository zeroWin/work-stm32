...
{    
	...
	{
		RTC_Get();
		OLED_ShowNum(0,16,calendar.hour,2,16);//显示ASCII字符的码值 
		OLED_ShowNum(16,16,calendar.min,2,16);
		OLED_ShowNum(32,16,calendar.sec,2,16);
		
		OLED_ShowNum(48,16,calendar.w_year,2,16);//显示ASCII字符的码值 
		OLED_ShowNum(64,16,calendar.w_month,2,16);
		OLED_ShowNum(80,16,calendar.w_date,2,16);
		
		OLED_ShowNum(96,16,calendar.week,2,16);
		OLED_Refresh_Gram();
