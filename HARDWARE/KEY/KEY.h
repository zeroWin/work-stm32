...
//---------------------------相关变量宏定义--------------------------
#define BUTTON_X_SHORT			0x01			//短按
#define BUTTON_X_LONG			0x02			//长按
#define BUTTON_X_DOUBLE			0x03			//双击

#define BUTTON_A_TYPE_ADRRESS	0x00
#define BUTTON_B_TYPE_ADRRESS	0x03

#define BUTTON_A_SHORT			BUTTON_X_SHORT+BUTTON_A_TYPE_ADRRESS			//短按 0x01
#define BUTTON_A_LONG			BUTTON_X_LONG+BUTTON_A_TYPE_ADRRESS				//长按 0x02
#define BUTTON_A_DOUBLE			BUTTON_X_DOUBLE+BUTTON_A_TYPE_ADRRESS			//双击 0x03

#define	BUTTON_B_SHORT			BUTTON_X_SHORT+BUTTON_B_TYPE_ADRRESS			//短按 0x04
#define BUTTON_B_LONG			BUTTON_X_LONG+BUTTON_B_TYPE_ADRRESS				//长按 0x05
#define BUTTON_B_DOUBLE			BUTTON_X_DOUBLE+BUTTON_B_TYPE_ADRRESS			//双击 0x06
	
#define BUTTON_A_PRESSED		0x07			//A按下
#define BUTTON_B_PRESSED		0x08			//B按下
#define NO_BUTTON_PRESSED		0x09			//没有按键按下

//---------------------------时间宏定义--------------------------
#define SHORT_PRESS_NUM			5			//短按的最小时间 25ms
#define LONG_PRESS_NUM			200			//长按的最小时间	1s
